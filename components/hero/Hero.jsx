                ...
                <div className="h-screen max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        <div className="flex space-x-7">
                            <div>
                                <Link href="/" className="flex items-center py-4 px-2 text-gray-700 logo" >
                    ...
                    <div className="flex flex-col justify-center items-center h-full text-center">
                        <h1 className="text-6xl font-bold text-gray-800 mb-2">
                            ...
                            <span className="text-zinc-500">
                                <Typewriter
                                    words={[' Friendly', ' Perfect', ' Professional']}
                                    loop={0}
                                    cursor
                                    cursorStyle='_'
                                    typeSpeed={100}
                        ...
                        <Link href="/builder" className="inline-block bg-zinc-300 text-zinc-600 px-6 py-3 rounded-lg font-bold text-lg hover:bg-zinc-600 hover:text-zinc-100 transition duration-200 hover:-translate-y-1 transform hover:shadow-lg">
                            Make My Resume
                        </Link>
                    </div>
                </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="mt-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex bg-zinc-500 rounded-lg shadow-lg p-4">
                        ...
                        <div className="flex bg-zinc-700 rounded-lg shadow-lg p-4">
